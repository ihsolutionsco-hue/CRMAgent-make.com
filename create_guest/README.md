...
```
create_guest/
├── create_guest.json  # Configuración de Make.com
├── Create Contact.md                 # Documentación OpenAPI
...
- Documentación OpenAPI: `Create Contact.md`
- Especificación Make.com: `create_guest.json`
