...
This endpoint will return all reservations that have been enabled for your channel key.
  ...
  "paths": {
    "/v2/pms/reservations": {
      "get": {
        ...
        "parameters": [
          {
            ...
            "in": "query",
            "name": "page",
            "description": "Page number of result set - Limited to 10k total results (page * size). Must be >= 1. Page 0 returns 400 Bad Request.",
            "required": false,
            "example": 1
          },
          {
            ...
            "in": "query",
            "name": "size",
            "description": "Size of page - Limited to 10k total results (page * size). Must be between 1 and 100.",
            "required": false,
            "example": 10
          },
          {
                                ...
                                "properties": {
                                  "unit": {
                                    ...
                                    "properties": {
                                      ...
                                      "checkoutTime": {
                                        "type": "string",
                                        "description": "Default check-out time (in unit timezone)"
                                      },
                                      "hasLateCheckout": {
                                        "type": "boolean",
                                      ...
                                      "lateCheckoutTime": {
                                        "type": "string",
                                        "description": "Requires hasLateCheckout. Time in unit timezone. Format \"HH:MM\""
                                      },
                                      "minBookingWindow": {
                                        "type": "integer"
                                      },
        ...
        "description": "This endpoint will return all reservations that have been enabled for your channel key.\n\n**Authentication Required:** This endpoint requires either Basic Authentication or HMAC authentication. Ensure your credentials are properly configured in make.com.\n\n**Important Notes:**\n- Page numbers start at 1 (not 0)\n- Maximum page size is 100\n- Dates must be in ISO 8601 format (e.g., 2025-10-27T00:00:00Z)\n- Use bookedStart/bookedEnd to filter by booking date\n- Use arrivalStart/arrivalEnd to filter by arrival date",
        "tags": [
          "Reservations"
        ]
      }
